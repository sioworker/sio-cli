...
## output
- colors (ok=green, err=red, host/contest/prob=cyan), off when not a tty or `NO_COLOR` set
- nicer msgs, icons + boxes, basically make it look like ai slop (✓ submitted, ✗ 401: bad token, etc)
