...
complete -c sio -n __fish_use_subcommand -a submit -d 'submit a solution'
...
complete -c sio -n '__sio_at config hosts' -a login -d 'web login, to see results on old oioioi'
complete -c sio -n '__sio_at config hosts' -a logout -d 'forget the web login'
complete -c sio -n '__sio_at config hosts add' -l main -s m -d 'make it the main host'
complete -c sio -n '__sio_at config hosts rm; or __sio_at config hosts main; or __sio_at config hosts token; or __sio_at config hosts login; or __sio_at config hosts logout; or __sio_at ping; or __sio_at info; or __sio_at tree' -a '(__sio_hosts)' -d host
complete -c sio -n '__sio_at config lang' -a '(__sio_langs) auto' -d lang
complete -c sio -n '__fish_seen_subcommand_from submit sub' -s n -l no-wait -d 'dont wait for the verdict'
complete -c sio -n '__fish_seen_subcommand_from submit sub; and test (count (commandline -opc)) -ge 3' -F
